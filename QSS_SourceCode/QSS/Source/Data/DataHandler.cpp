...
void DataHandler::setBatchSpectralDataForSonification()
{
    ...
    // set the overview sonification playback parameters for broadcasting via osc to Max/MSP to play the sound...
    overviewPlayback->setMainOverviewPlayback(selectedBatchSpectralData);
